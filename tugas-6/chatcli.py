...
class ChatClient:
    ...
    def send_message(self, usernameto="xxx", message="xxx"):
        ...
        string = "send {} {} {}\r\n" . format(self.token_id, usernameto, message)
        result = self.send_string(string)
        if result['status'] == 'ok':
    ...
    def send_message_to_server(self, server_to, username_to, message):
        if self.token_id == "":
            return "Error: not authorized"
        string = 'sendtoserver {} {} {} {}\r\n'.format(self.token_id, server_to, username_to, message)
        result = self.send_string(string)
        if result['status'] == 'ok':
    ...
    def send_file(self, address, filename):
        if self.token_id == "":
            return "Error: not authorized"
        string = "sendfile {} {} {}\r\n" .format(self.token_id, address, filename)
        result = self.send_string(string)
        if result['status'] == 'ok':
    ...
    def send_file_to_server(self, address, filename):
        ...
        string = 'sendfileserver {} {} {} {}\r\n'.format(self.token_id, server_from, address, filename)
        result = self.send_string(string)
        if result['status'] == 'ok':
    ...
    def send_file_group(self, server_id, group_id, filename):
        ...
        string = 'sendfilegroup {} {} {} {}\r\n'.format(self.token_id, server_id, group_id, filename)
        result = self.send_string(string)
        if result['status'] == 'ok':
    ...
    def sendgroupmessage(self, group_id, message):
        if self.token_id == "":
            return "Error: not authorized"
        string = "sendgroup {} {} {} {}\r\n" . format(self.token_id, group_id, self.server, message)
        result = self.send_string(string)
        if result['status'] == 'ok':
